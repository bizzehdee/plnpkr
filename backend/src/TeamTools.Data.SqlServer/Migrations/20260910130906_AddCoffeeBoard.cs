        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhaseDurationSeconds = table.Column<int>(type: "int", nullable: true),
                    PhaseDeadline = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    VoteBudget = table.Column<int>(type: "int", nullable: false),
                    AllowMultiplePerItem = table.Column<bool>(type: "bit", nullable: false),
                    CurrentTopicId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ExtendVoteOpen = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Choice = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscussedSeconds = table.Column<int>(type: "int", nullable: false),
