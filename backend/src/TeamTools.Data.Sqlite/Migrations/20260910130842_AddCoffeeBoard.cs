        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhaseDeadline = table.Column<DateTimeOffset>(type: "TEXT", nullable: true),
                    VoteBudget = table.Column<int>(type: "INTEGER", nullable: false),
                    AllowMultiplePerItem = table.Column<bool>(type: "INTEGER", nullable: false),
                    CurrentTopicId = table.Column<Guid>(type: "TEXT", nullable: true),
                    ExtendVoteOpen = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Choice = table.Column<string>(type: "TEXT", maxLength: 16, nullable: false)
                },
                constraints: table =>
                {
